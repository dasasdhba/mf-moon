...
namespace GodotTask
{
    ...
    public partial struct GDTask
    {
        ...
        /// <summary>
        /// Delay the execution after <paramref name="secondsDelay"/> on provided <see cref="PlayerLoopTiming"/> with <see cref="DelayType.DeltaTime"/> provider, with specified <see cref="CancellationToken"/>.
        /// </summary>
        /// <exception cref="ArgumentOutOfRangeException"><paramref name="secondsDelay"/> is less than 0.</exception>
        public static GDTask Delay(double secondsDelay, PlayerLoopTiming delayTiming = PlayerLoopTiming.Process, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// </summary>
        /// <exception cref="ArgumentOutOfRangeException"><paramref name="secondsDelay"/> is less than 0.</exception>
        public static GDTask Delay(double secondsDelay, DelayType delayType, PlayerLoopTiming delayTiming = PlayerLoopTiming.Process, CancellationToken cancellationToken = default(CancellationToken))
        {
            var delayTimeSpan = TimeSpan.FromSeconds(secondsDelay);
            return Delay(delayTimeSpan, delayType, delayTiming, cancellationToken);
        }
